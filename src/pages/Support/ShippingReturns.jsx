        ...
        <div className="space-y-10">
          <div>
            ...
            <div className="space-y-4 leading-relaxed">
              <p>
                Our returns and refunds policy lasts 30 days. If 30 days have
                passed since your purchase, we unfortunately can’t offer you a
                full refund or exchange.
              </p>
              <p>
                To be eligible for a return, your item must be unused and in the
                same condition that you received it. It must also be in the
                original packaging. For health and safety reasons, several types
                of goods are exempt from being returned, including perishable
                items, health and personal care products, and supplements that
                have been opened.
              </p>
              <p>
          ...
          <div>
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <p>
                ...
                <a
                  href="mailto:support@pharmaai.com"
                  className="text-blue-500 hover:underline"
                >
                  support@pharmaai.com
                </a>
                .
              </p>
            </div>
          ...
          <div>
            ...
            <p className="leading-relaxed">
              ...
              arrival. If you need to exchange it for the same item, send us an
              email at{" "}
              <a
                href="mailto:support@pharmaai.com"
                className="text-blue-500 hover:underline"
              ...
              and send your item to: PharmaAI Returns, 123 Innovation Drive,
              Boston, MA 02110.
            </p>
          </div>
