           ...
           <div className=" bg-gray-50">
            ...
            <section className="pt-12 bg-gray-50 sm:pt-16">
               ...
               <div className="grid items-center grid-cols-2 gap-y-24 lg:grid-cols-2 gap-x-24">
                <div>
                   <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">Tired of Guessing Your
             <span  className="text-sage">Skincare Routine?</span>
               </h1>
                      <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Our AI-powered quiz analyzes your skin's unique needs to recommend a personalized regimen that actually works for you.
                  </p>
                        ...
                        <Avatar/>   <span data-testid="text-social-proof">Over 50,000 AI-powered routines created</span>
                    </div>
                      <div className="relative">
                       <div className="features-video-container">
            <video className="FeatureVideo" autoPlay loop muted preload="true" loading="lazy" playsInline >
